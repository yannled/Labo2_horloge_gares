...
public class Amorce {
    public static void main (String argv[]){
        ...
        Emetteur emetteur = new Emetteur(600);  	// Emetteur avec une seconde de 100msec
        ...
        Pendule pendule1 = new Pendule(550);
        ...
        Pendule pendule2 = new Pendule(650);
        ...
        Pendule pendule3 = new Pendule(600);
        ...
        Pendule pendule4 = new Pendule(600);
